...
const ALL_CREATIONS: CreationItem[] = [
  {
    id: 1,
    titleId: "Bolu Chiffon Keju Susu Segar",
    titleEn: "Fresh Baked Cheese Chiffon",
    image: "/images/hero/bolu-hero-splash.jpg",
  },
  {
    id: 2,
    titleId: "Sajian Bolu Bersama Teh Hangat",
    titleEn: "Signature Chiffon with Tea",
    image: "/images/products/bolu-keju-original.jpg",
  },
  {
    id: 3,
    titleId: "Potongan Bolu Tekstur Lembut",
    titleEn: "Assorted Cake Slices",
    image: "/images/products/bolu-keju-turnaround.jpg",
  },
  {
    id: 4,
    titleId: "Keranjang Roti Artisan & Bolu",
    titleEn: "Artisan Bread & Cake Basket",
    image: "/images/brand/bread-basket-contact.jpg",
  },
  {
    id: 5,
    titleId: "Bolu Pandan Keju Susu Murni",
    titleEn: "Pandan Cheese Milk Chiffon",
    image: "/images/products/bolu-keju-original.jpg",
  },
  {
    id: 6,
    titleId: "Donat Kentang Gula Salju",
    titleEn: "Classic Snow Sugar Donuts",
    image: "/images/products/bolu-keju-turnaround.jpg",
  },
  {
    id: 7,
    titleId: "Bolu Ganache Cokelat Belgia",
    titleEn: "Belgian Dark Chocolate Chiffon",
    image: "/images/hero/bolu-hero-splash.jpg",
  },
  {
    id: 8,
    titleId: "Kotak Hantaran Hardbox Eksklusif",
    titleEn: "Luxury Gift Box Hampers",
    image: "/images/brand/bread-basket-contact.jpg",
  },
];
