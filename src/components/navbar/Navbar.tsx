...
import { ShoppingBag, Menu, X, ArrowUpRight, MapPin } from "lucide-react";
    ...
    >
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between gap-3">
          ...
          <nav className="hidden md:flex items-center gap-5 lg:gap-7 text-sm font-bold text-[#291E16]">
            <Link
              href="#hero"
          ...
          <div className="flex items-center gap-2 sm:gap-2.5 shrink-0">
            ...
            <button
              ...
              className="flex items-center gap-1.5 px-2.5 sm:px-3 py-1.5 rounded-xl bg-white border border-[#F1E5D1] hover:border-[#F58A42] text-[#291E16] hover:bg-[#FFF8EE] text-xs font-heading font-black shadow-2xs transition-all cursor-pointer group shrink-0"
            ...
            <div className="flex items-center bg-white border border-[#F1E5D1] rounded-xl p-1 text-xs font-heading font-black shadow-2xs shrink-0">
              <button
            ...
            <button
              ...
              className="relative p-2.5 rounded-xl bg-white border border-[#F1E5D1] text-[#291E16] hover:bg-[#FFF8EE] transition-all shadow-2xs group cursor-pointer shrink-0"
            ...
            <Link
              href="#kontak"
              className="hidden sm:inline-flex items-center gap-2.5 pl-4 pr-1.5 py-1.5 rounded-xl bg-[#291E16] text-white hover:bg-[#423125] text-xs sm:text-sm font-bold transition-all shadow-xs group shrink-0"
            >
            ...
            <button
              ...
              className="md:hidden p-2 rounded-xl bg-white border border-[#F1E5D1] text-[#291E16] shrink-0"
